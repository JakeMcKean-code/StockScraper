...
# Make a colour scheme for the mplfinance candlestick charts
...
# Create a gridspec and assign axes to their positions
...
# Function to calculate the change in the close value
...
# Function to resample the dataframe over a specified time period
...
# -------------------------------------- Animation function --------------------------------------
def animate(i):
    # Preprocess the data, remove NaNs and apply DatetimeIndex
    df = preprocessing()
    ...
    # Plot the side panels using the ax list for brevity 
...
if __name__ == '__main__':
    ...
    # Define extra padding options for the graph window
